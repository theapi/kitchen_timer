...
#define NUM_0      B00000101 // 0
#define NUM_1      B01111101 // 1
#define NUM_2      B00100110 // 2
#define NUM_3      B00110100 // 3
#define NUM_4      B01011100 // 4
#define NUM_5      B10010100 // 5
#define NUM_6      B11000100 // 6
#define NUM_7      B00111101 // 7
#define NUM_8      B00000100 // 8
#define NUM_9      B00010000 // 9
#define NUM_BLANK  B11111111 // ' '
